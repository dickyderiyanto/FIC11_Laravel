    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Add Products</h1>
                {{-- <p class="section-lead">Tambahkan user sesuai dengan form berikut</p> --}}
                ...
                <p class="section-lead">We provide advanced input fields, such as date picker, color picker, and so on.</p> --}}
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>Price</label>
                                    <input type="number" value="0" class="form-control @error('price')
                                        is-invalid
                                    @enderror"
                                    name="price">
                                    @error('price')
                                ...
                                <div class="form-group">
                                    <label>Stock</label>
                                    <input type="number" value="0" class="form-control @error('stock')
                                        is-invalid
                                    @enderror"
                                    name="stock">
                                    @error('stock')
